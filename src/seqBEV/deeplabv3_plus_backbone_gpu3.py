...
from src.nets.mobilenetv3 import MobileNetV3, mobilenetv3_large
...
class ResNet(nn.Module):
    def __init__(self, downsample_factor=8, pretrained=True, IF_shift = False):
        ...
        self.backbone = ['resnet18', 'resnet34', 'resnet50', 'resnet101', 'resnet152']
...
class DeepLab(nn.Module):
    def __init__(self, num_classes, num_classes_layout=4, backbone="mobilenet_v3", pretrained=True, downsample_factor=16):
        ...
        if backbone=="xception":
            ...
            #   主干部分    [32,64,320]
            #----------------------------------#
            self.backbone = MobileNetV3_large(downsample_factor=downsample_factor, pretrained=pretrained, IF_shift=False)  # 空间特征提取
            self.backbone_temporal = MobileNetV3_large(downsample_factor=downsample_factor, pretrained=pretrained, IF_shift=True)  # 时间特征提取
            in_channels = 160
            low_level_channels = 24
        elif backbone=="resnet_18":  # for resnet18/34
            #----------------------------------#
            #   获得两个特征层
            #   浅层特征    [64,128,256]
            #   主干部分    [32,64,2048]
        ...
        elif backbone=="resnet": # for resnet50/101/152
            #----------------------------------#
            #   获得两个特征层
            #   浅层特征    [64,128,256]
            #   主干部分    [32,64,2048]
...
if __name__ == '__main__':
    ...
    backbone_net = "MobileNetV3_large"
