...
if __name__ == '__main__':
    ...
    for param in model.backbone.parameters():
        param_test.append(param)
    backbone_param = list(model.backbone.parameters())
    total_param = list(model.parameters())
    other_param = list(set(total_param)^set(backbone_param))
    #other_param = [param for param in total_param if param not in backbone_param]
    # for param in model.parameters():
    #     if param not in model.backbone.parameters():
    #         other_param.append(param)
    print("if param_test == backbone_param: ", param_test == backbone_param)
    print("len(param_test) ,len (backbone_param), len(total_param): ", len(param_test) ,len (backbone_param), len(total_param))
    print("len(param_test) ,len (backbone_param): ", len(total_param) , len(other_param))
